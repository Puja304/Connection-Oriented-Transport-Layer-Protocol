...
class ReliableTransportLayerProtocol:

    # will have the following fields
    def __init__(self, syn = False, ack = False, fin = False, source_port_num, dest_port_num, seq_num, ack_num, receiver_window, app_data= ""):
        self.syn = syn
        self.ack = ack
        self.fin = fin
    ...
    def from_bytes(data):
        ...
        return ReliableTransportLayerProtocol(syn = syn, ack = ack, fin=fin, source_port_num=source_port_num, dest_port_num=dest_port_num, seq_num=seq_num, ack_num=ack_num, receiver_window=receiver_window, app_data=payload)
